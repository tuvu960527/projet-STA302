...
## Importation et construction de la base de données
...
## Création du jeu de données "data"
```{r}
df$AGEINT <- df$AGE5
...
### Comparaison de la variation des scores d'ISAAC dans chaque groupe de variables 
...
- OBSTIME:RNFLG: 0.6066 et I(OBSTIME^2)*RNFLG: 0.5612
